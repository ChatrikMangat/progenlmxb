...
# This example file creates the directory structure and MESA input files for the LMLP section of the set. The initial donor mass (Msol) and log10(orbital period/days) values are set by mvals and pvals in the code.  

mvals=($(seq 4.0 0.1 7.0))
pvals=($(seq 1.65 0.05 4.0))
