...
# This example file creates the directory structure and MESA input files for the SMLP section of the set. The initial donor mass (Msol) and log10(orbital period/days) values are set by mvals and pvals in the code.
